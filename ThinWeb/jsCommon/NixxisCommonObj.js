...
var crNewCallDialog =
{
	...
	Show : function()
	{
	    ...
	    crNewCallDialog.crWindow.txSize = new toolboxSize(260, 265);
	    crNewCallDialog.crWindow.txLocation = new toolboxPoint(1, 50);
	    crNewCallDialog.crWindow.txMoveMin = new toolboxPoint(1, 50);
	    crNewCallDialog.crWindow.txMoveMax = new toolboxPoint(document.body.clientWidth, document.body.clientHeight);
	    crNewCallDialog.crWindow.setTitle(CrResource.newContactForm.title);
	    crNewCallDialog.crWindow.Show();
	    crNewCallDialog.crWindow.setResizeble(false);
	    ...
	    _BODY += '                                  <div id="MCText" class="MCText"></div>'; 
	    _BODY += '                                  <input id="MCNum" class="MCNum" type="text" MAXLENGTH="100"/>';
		//_BODY += '                                  <input id="MCNum" class="MCNum" type="text" onkeypress="javascript: return crNewCallDialog.KeyPress(event);"/>';
	    _BODY += '                              </div>'; 
	    _BODY += '                         </td>'; 
	    _BODY += '                        <td id="MCallDialPad_Dial"></td>';
	    _BODY += '                    </tr>';
	    ...
	    crNewCallDialog.crDialPadBtn[_Key].txButtonType = txEnum.BtnType.PictureBtn;
	    crNewCallDialog.crDialPadBtn[_Key].txImage         = new toolboxImage(CrResource.newContactForm.buttonDial[0] , new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageOver     = new toolboxImage(CrResource.newContactForm.buttonDial[1], new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageFocus    = new toolboxImage(CrResource.newContactForm.buttonDial[2], new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageDisabled = new toolboxImage(CrResource.newContactForm.buttonDial[3], new toolboxSize(80, 37));    
	    ...
	    crNewCallDialog.crDialPadBtn[_Key].txButtonType = txEnum.BtnType.PictureBtn;
	    crNewCallDialog.crDialPadBtn[_Key].txImage         = new toolboxImage(CrResource.newContactForm.buttonClear[0], new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageOver     = new toolboxImage(CrResource.newContactForm.buttonClear[1], new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageFocus    = new toolboxImage(CrResource.newContactForm.buttonClear[2], new toolboxSize(80, 37));
	    crNewCallDialog.crDialPadBtn[_Key].txImageDisabled = new toolboxImage(CrResource.newContactForm.buttonClear[3], new toolboxSize(80, 37)); 
	    crNewCallDialog.crDialPadBtn[_Key].txAlt = "Clear";
	    crNewCallDialog.crDialPadBtn[_Key].txTitle = "Clear";       
	    crNewCallDialog.crDialPadBtn[_Key].Show();
	    
	    this.setStatus(CrResource.newContactForm.statusEnterNumber);
		crNewCallDialog.crWindow.setUserBackground(true, "#3b393c", "url('img/ManualCall_Background.png')", [["background-repeat","repeat-x"]])
	},
	CreateButton: function(key, onclickFn)
	{
	    ...
	    button.txImage         = new toolboxImage("img\\btnPad_" + key + ".png", new toolboxSize(80, 37));
	    button.txImageOver     = new toolboxImage("img\\btnPadOver_" + key + ".png", new toolboxSize(80, 37));
	    button.txImageFocus    = new toolboxImage("img\\btnPad_" + key + ".png", new toolboxSize(80, 37));
	    button.txImageDisabled = new toolboxImage("img\\btnPad_" + key + ".png", new toolboxSize(80, 37));
	    if (isNaN(parseInt(key)))
	    {
	        button.txAlt = key;
	        button.txTitle = key;
