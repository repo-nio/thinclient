...
var const_AgentVersionBuild = "2";
var const_AgentVersionRevision = "24";
...
var CrResource = 
{
	...
	toolbar: 
	{
		AgentToolStrip : 
		{
			...
			WaitForCall : ["Wait for call", "Wait for call"],
			WaitForMail : ["Wait for mail", "Wait for mail"],
			WaitForChat : ["Wait for chat", "Wait for chat"],
			TeamSelection : ["Select active teams", "Select active teams"],
			Pause : ["Pause","Pause"],
			PriorityPickup : ["Vip","Vip"],
			CloseScript : ["Close script","Close script"],
...
var CrResource_Es = 
{
	...
	QualificationForm : 
	{
		title : "Elegir cualificación"
	},
	pagePause : 
	{
		_T1 : "Agente está actualmente en pausa",
		_T2 : "Haga click en Listo para comenzar"
	},
	pageWaiting : 
	{
		_T1 : "Esperando contacto"
	},
	contactTab : 
	{
		buttonDestination : "Dest:",
	...
	toolbar: 
	{
		...
		{
			//[ Alt, title]
			agentLabel : ["Comandos de Agente", "Comandos de Agente"],
			WaitForCall : ["Esperar Llamada", "Esperar Llamada"],
			WaitForMail : ["Esperar Email", "Esperar Email"],
			WaitForChat : ["Esperar Chat", "Esperar Chat"],
			TeamSelection : ["Elegir Equipos activos", "Elegir Equipos activos"],
			Pause : ["Pausa","Pausa"],
			PriorityPickup : ["VIP","VIP"],
			CloseScript : ["Cerrar Script","Cerrar Script"],
			Selectqual : ["Elegir cualificación","Elegir cualificación"],
			SearchMode : ["Modo Búsqueda","Modo Búsqueda"]
		},
		VoiceToolStrip : 
		{
			//[ Alt, title]
			voiceLabel : ["Comandos de Voz" ,"Comandos de Voz"],
			VoiceNewCall : ["Llamar", "Llamar"],
			VoiceHold : ["Poner en espera", "Poner en espera"],
			VoiceRetrieve : ["Recuperar llamada", "Recuperar llamada"],
			VoiceTransfer : ["Transferir llamada", "Transferir llamada"],
			VoiceConference : ["Conferencia", "Conferencia"],
			VoiceForward : ["Desviar llamada", "Desviar llamada"],
			VoiceHangup : ["Colgar llamada", "Colgar llamada"]
		},
		MailToolStrip : 
		{
			//[ Alt, title]
			mailLabel : ["Comandos de Email" ,"Comandos de Email"],
			MailNewMail : ["Nuevo email", "Nuevo email"],
			MailReply : ["Responder email", "Responder email"],
			MailForward : ["Desviar email", "Desviar mail"]
		},
		ChatToolStrip : 
		{
			//[ Alt, title]
			chatLabel : ["Comandos de Chat" ,"Comandos de Chat"],
			ChatNewChat : ["Nuevo chat", "Nuevo chat"],
			ChatHold : ["Retener chat", "Retner chat"],
			ChatRetrieve : ["Recuperar chat", "Recuperar chat"],
			ChatHangup : ["Cerrar chat", "Cerrar chat"]
		}
	...
	{
		title : "Info",
		titleAgt : " Información de Agente",
		titleQueue : " Información de Cola",
		titleContact : " Información de Contacto",
		agtName : "Nombre",
		agtAccount : "Cuenta",
		queueWaiting : "En espera",
		queuePriority : "Prioritarias",
		contactState : "Estado",
		contactTo : "A",
		contactFrom : "De"
	}	
